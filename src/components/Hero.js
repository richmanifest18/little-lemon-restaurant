...
function Hero() {
    return (
        <>
            <section className="hero container" aria-labelledby="heroHeading">
                <div className="hero__wrapper__container">
                    <div className="hero__heading">
                        ...
                        <Link to="/Reservations" className="hero__btn btn2" role="button" aria-label="On Click">Reserve a Table</Link>
                    </div>
