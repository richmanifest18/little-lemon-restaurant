...
function Highlights() {
    return (
        <>
            <section className="highlights container section" aria-labelledby="highlightsTitle">
                <div className="highlights__title-wrapper">
                    <h1 className="highlights__title">This week's specials!</h1>
                </div>
                <div className="highlights__card-wrapper" role="list">
                    <div className="card" role="listitem">
                        ...
                        <div className="card__delivery-wrapper" role="region" aria-labelledby="deliveryTitle">
